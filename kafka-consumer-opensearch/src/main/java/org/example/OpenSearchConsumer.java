...
public class OpenSearchConsumer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //create index on os if not present
        try (opensearchClient; consumer){
            ...
            consumer.subscribe(Collections.singletonList("wikimedia.recent.changes"));
            while (true) {
                ConsumerRecords<String, String> records = consumer.poll(Duration.ofMillis(3000));
                int recordsCount = records.count();
                log.info("The records have been created + " + recordsCount);
...
//                    log.info(indexResponse.getId());
                ...
                if (bulkRequest.numberOfActions() > 0) {
                    ...
                    log.info("Inserted " + bulkResponse.getItems().length + " records and id");
                }
            }
        }
